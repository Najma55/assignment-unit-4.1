...
console.log(helloName ('Najma Jama'))
...
console.log('running multiplyThree with 6, 7, & 3:',multiplyThree(6,7,3));
...
console.log('Expext undefined:' , array)
// 7. Function to find a value in an array. Return true if the 
//    value is found and false otherwise. Use a loop;
//    DO NOT use Array.includes, Array.indexOf, or Array.find 
let arrayTosearch = [2,4,6,7,5];
